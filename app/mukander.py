...
def first_start():
    ...
    ltext1=Label(lwindow, background=bg, foreground=fg, font="arial 10 bold", text="Please choose a language for Mukander.\nMukander için lütfen bir dil seçin.")
    ltext1.pack()
...
if os.path.isfile(en):
    ...
    sobutton=Button(window, font="arial 10", cursor="hand2", activebackground=a_button_bg, activeforeground=a_button_fg, foreground=button_fg, background=button_bg, borderwidth="3", text="Settings", command=settings)
    ...
    space2=Label(window, background=bg, foreground=fg, text="\n", font="arial 5")
    sobutton=Button(window, font="arial 10", cursor="hand2", activebackground=a_button_bg, activeforeground=a_button_fg, foreground=button_fg, background=button_bg, borderwidth="3", text="Ayarlar", command=settings)
    space3=Label(window, background=bg, foreground=fg, text="\n", font="arial 1")
text1.pack()
space1.pack()
cmdentry.pack()
