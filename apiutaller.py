...
appname="Mukander" # Option: "<your program name>"
appfolder="/usr/bin/" # Option: "<your main code folder>"
appfileold="mukander.py" # Option: "<your main code file old name>"
appfilenew="mukander" # Option: "<your main code file new name>"
policyfile=any # Options: "<your policy file>" and any
appdesktopfile="mukander.desktop" # Options: "<your desktop file>" and any
mainappfolder="/usr/local/bin/" # Options: "<your way to main app folder>" and any
mainappfoldername="mukander" # Options: "<your main app folder name for icons, modules etc.>" and any
licensename="GPLv3" # # Options: "<your program's license>" and any
appdev="MuKonqi" # Option: "<your name>"
appcopyright="Copyright (C) 2023 Muhammed Abdurrahman (MuKonqi)" # Option: "<your copyright nofication>"
applicense='Mukander is free software: you can redistribute it and/or modify\nit under the terms of the GNU General Public License as published by\nthe Free Software Foundation, either version 3 of the License, or\n(at your option) any later version.\n\nMetterXP is distributed in the hope that it will be useful,\nbut WITHOUT ANY WARRANTY; without even the implied warranty of\nMERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the\nGNU General Public License for more details.\n\nYou should have received a copy of the GNU General Public License\nalong with MetterXP.  If not, see <https://www.gnu.org/licenses/>.' # Option: "<important section from your program's license>" 
debian_apt_support="true" # Options: For true "true", and for false "false"
debian_apt_dependencies="python3 python3-tk" # Options: "<your program's dependencies>" and any
fedora_dnf_support="true" # Options: For true "true", and for false "false"
fedora_dnf_dependencies="python3 python3-tkinter" # Options: "<your program's dependencies>" and any
arch_pacman_support="true" # Options: For true "true", and for false "false"
arch_pacman_dependencies="python3 tk" # Options: "<your program's dependencies>" and any
opensuse_zypper_support="true" # Options: For true "true", and for false "false"
opensuse_zypper_dependencies="python3 python3-tk" # Options: "<your program's dependencies>" and any
rhel_yum_support="true" # Options: For true "true", and for false "false"
rhel_yum_dependencies="python3 tkinter tk-devel" # Options: "<your program's dependencies>" and any
solus_eopkg_support="true" # Options: For true "true", and for false "false"
solus_eopkg_dependencies="python3 python3-tkinter" # Options: "<your program's dependencies>" and any
void_xbps_support="true" # Options: For true "true", and for false "false"
void_xbps_dependencies="python3 python3-tkinter" # Options: "<your program's dependencies>" and any
