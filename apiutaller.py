...
appname="Mukander" # Don't forget to change this! This is necessary for Apiutaller.
appfolder="/usr/bin/" # Don't forget to change this! This is necessary for Apiutaller.
appfileold="mukander.py" # Don't forget to change this! This is necessary for Apiutaller.
appfilenew="mukander" # Don't forget to change this! This is necessary for Apiutaller.
policyfile=any # Options: policy file and any
appdesktopfile="mukander.desktop" # Options: desktop file and any
mainappfolder="/usr/local/bin/" # Options: Your way for your main app folder or any
mainappfoldername="mukander" # Options your main app folder for icon, modules etc. or any
...
debian_apt_dependencies="python3 python3-tk" # Options: "dependencies" and any
fedora_dnf_support="true" # Options: true and false
fedora_dnf_dependencies="python3 python3-tkinter" # Options: "dependencies" and any
arch_pacman_support="true" # Options: true and false
arch_pacman_dependencies="python3 tk" # Options: "dependencies" and any
opensuse_zypper_support="true" # Options: true and false
opensuse_zypper_dependencies="python3 python3-tk" # Options: "dependencies" and any
rhel_yum_support="true" # Options: true and false
rhel_yum_dependencies="python3 tkinter tk-devel" # Options: "dependencies" and any
solus_eopkg_support="true" # Options: true and false
solus_eopkg_dependencies="python3 python3-tkinter" # Options: "dependencies" and any
void_xbps_support="true" # Options: true and false
void_xbps_dependencies="python3 python3-tkinter" # Options: "dependencies" and any
